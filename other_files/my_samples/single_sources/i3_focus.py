...
# Here we can for example remember currently focused window so that we can
# swtich back to it later.

# bindsym $Alt_L+h exec --no-startup-id exec $DOTRC/other_files/i3_focus.py left
